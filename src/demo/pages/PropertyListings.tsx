...
const SAMPLE_LISTINGS = [
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1560449752-3fd74f3f4f98?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
  ...
  },
  {
    ...
    description: 'Well-maintained HDB flat near Tampines Hub. Bright and airy with excellent amenities nearby.',
    features: ['Near MRT', 'Shopping Malls', 'Schools', 'Parks'],
    lastUpdated: '2024-03-14',
    publishedOn: ['99.co'],
    aiSuggestions: 'Recent rental transactions suggest potential for 5% increase in rental price.',
    rentalYield: '3.8%',
  },
  {
    id: 3,
    ...
    description: 'Prestigious penthouse with panoramic city views. Private pool and entertainment deck.',
    features: ['Private Pool', 'Smart Home', 'Private Lift', 'Wine Cellar'],
    lastUpdated: '2024-03-16',
    publishedOn: ['99.co', 'PropertyGuru'],
    aiSuggestions: 'Luxury market showing strong interest. Highlight exclusive features and privacy aspects.',
    rentalYield: null,
  },
  {
    id: 4,
    ...
    description: 'Elegant semi-detached house with modern architecture and lush garden.',
    features: ['Private Garden', 'Swimming Pool', 'Smart Home System', 'Double Garage'],
    lastUpdated: '2024-03-17',
    publishedOn: ['99.co', 'PropertyGuru'],
    aiSuggestions: 'Landed properties in this area are in high demand. Emphasize the garden space and privacy.',
    rentalYield: null,
  },
  {
    id: 5,
    title: 'Executive HDB in Punggol',
    address: '789 Punggol Drive',
    price: 3500,
    type: 'HDB',
    listingType: 'rental',
    beds: 5,
    ...
    description: 'Renovated executive apartment with waterfront views. Perfect for large families.',
    features: ['Waterfront View', 'Near LRT', 'Renovated Kitchen', 'Study Room'],
    lastUpdated: '2024-03-15',
    publishedOn: ['99.co'],
    aiSuggestions: 'Executive flats are trending in Punggol. Highlight the waterfront lifestyle.',
    rentalYield: '4.2%',
  }
];
